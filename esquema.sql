...
insert into dim_familias (codigo, nome, categoria, segmento, marca) values
  ...
  ('054', 'CHINELOS OLYMPIKUS FB BR',  'CHINELO OLY',        'CHINELO',                  'OLYMPIKUS'),
  ('056', 'SAPATO AZALEIA',            'SAPATO AZALEIA',     'FEMININO',                 'AZALEIA'),
  ('058', 'TÊNIS OLYMPIKUS',           'TÊNIS OLYMPIKUS',    'TÊNIS OLYMPIKUS',          'OLYMPIKUS'),
  ('060', 'VESTUARIO OLYMP.TERCEIROS', 'VESTUÁRIO OLY',      'TÊXTIL/ACESSÓRIOS OLY',    'OLYMPIKUS'),
  ('061', 'ACESSORIO OLYMP.TERCEIROS', 'ACESSÓRIOS OLY',     'TÊXTIL/ACESSÓRIOS OLY',    'OLYMPIKUS'),
  ('068', 'MEIAS OLYMPIKUS',           'MEIAS OLY',          'TÊXTIL/ACESSÓRIOS OLY',    'OLYMPIKUS'),
  ('069', 'VESTUÁRIO OLY',             'VESTUÁRIO OLY',      'TÊXTIL/ACESSÓRIOS OLY',    'OLYMPIKUS'),
  ('076', 'TENIS AZALEIA',             'TENIS AZALEIA',      'FEMININO',                 'AZALEIA'),
  ('077', 'TENIS DIJEAN',              'TENIS DIJEAN',       'FEMININO',                 'DIJEAN'),
  ('080', 'TENIS UA FABRICADO BRASIL', 'TÊNIS UA',           'TÊNIS UA',                 'UNDER ARMOUR'),
  ('081', 'TENIS UA COMPRADO',         'TÊNIS UA',           'TÊNIS UA',                 'UNDER ARMOUR'),
  ('082', 'VESTUARIO UA COMPRADO',     'VESTUÁRIO UA',       'TÊXTIL/ACESSÓRIOS UA',     'UNDER ARMOUR'),
  ('083', 'ACESSORIO UA COMPRADO',     'ACESSÓRIOS UA',      'TÊXTIL/ACESSÓRIOS UA',     'UNDER ARMOUR'),
  ('084', 'MEIA UA COMPRADO',          'MEIAS UA',           'TÊXTIL/ACESSÓRIOS UA',     'UNDER ARMOUR'),
  ('085', 'FUTEBOL UA',                'FUTEBOL UA',         'TÊXTIL/ACESSÓRIOS UA',     'UNDER ARMOUR'),
  ('086', 'CHINELO UA FB BRASIL',      'CHINELO UA',         'CHINELO',                  'UNDER ARMOUR'),
  ('087', 'CHINELO UA COMPRADO',       'CHINELO UA',         'CHINELO',                  'UNDER ARMOUR'),
  ...
  ('106', 'CHINELOS MIZUNO FB BR',     'CHINELO MZ',         'CHINELO',                  'MIZUNO'),
  ('107', 'CHUTEIRA MIZUNO FB BRASIL', 'CHUTEIRA MZ',        'CHUTEIRA MZ',              'MIZUNO'),
  ('108', 'CHUTEIRA MIZUNO IMPORTADA', 'CHUTEIRA MZ',        'CHUTEIRA MZ',              'MIZUNO'),
  ('109', 'VEST.MIZUNO CLUBE COMPRAD', 'BOTAFOGO MIZ',       'TÊXTIL/ACESSÓRIOS MIZUNO', 'MIZUNO')
on conflict (codigo) do update
